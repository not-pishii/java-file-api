...
class BitwiseOpsCompileTest {
    ...
    void bitwiseAndShiftOperatorsCompile() {
        JavaFile file = JavaFile.of(ClassDesc.of("me.supcheg.example", "Bits"), cb -> cb.withMethod(
                "pack",
                ...
                mb -> mb.withParam("high", PrimitiveTypeRef.INT)
                        ...
                        .withBody(b -> b.return_(b.bitOr(
                                b.shl(b.field("high"), b.literal(16)), b.bitAnd(b.field("low"), b.bitNot(b.literal(0))))))));
