...
/// unmodifiable lists. The method always renders with the `static` modifier;
/// it carries no explicit [Modifier] set because that is the only form Java
/// allows for a static interface method.
///
